...
def final():
    ...
    global confThreshold, nmsThreshold
    ...
    classesFile = "applications/Traffic/static/coco.names"
    global classes
    classes = None
    ...
    modelConfiguration = "applications/Traffic/static/yolov3.cfg"
    modelWeights = "applications/Traffic/static/yolov3.weights"
    result=[]
